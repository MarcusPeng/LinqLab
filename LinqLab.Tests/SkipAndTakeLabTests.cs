...
namespace LinqLab.Tests
{
    public class SkipAndTakeLabTests
    {
        ...
        {
            _skipAndTakeLab = new SkipAndTakeLab(new SampleData().Data);
        }

        [TestMethod()]
        public void 跳過五筆資料Test()
        {
            var expected =
           new List<Sample>
            {
            ...
            var actual = _skipAndTakeLab.跳過五筆資料();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void 取得五筆資料Test()
        {
            var expected =
          new List<Sample>
            {
            ...
            var actual = _skipAndTakeLab.取得五筆資料();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void 跳過五筆取得兩筆Test()
        {
            var expected =
          new List<Sample>
            {
            ...
            var actual = _skipAndTakeLab.跳過五筆取得兩筆();
