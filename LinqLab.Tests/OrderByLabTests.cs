...
{
    [TestClass()]
    public class OrderByLabTests
    {
        private OrderByLab _orderByLab;

        [TestInitialize]
        public void TestInitialize()
        {
            _orderByLab = new OrderByLab(new SampleData().Data);
        }

        [TestMethod()]
        public void 請使用Id升冪排序Test()
        {
            var expected =
              new List<Sample>
          {
            ...
            var actual = _orderByLab.請使用Id升冪排序();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void 請使用Id降冪排序Test()
        {
            var expected =
               new List<Sample>
           {
            ...
            var actual = _orderByLab.請使用Id降冪排序();

            expected.ShouldEqual(actual.ToList());
        }

        [TestMethod()]
        public void 請使用Price昇冪排序後再使用Id昇冪排序Test()
        {
            var expected =
               new List<Sample>
           {
            ...
            var actual = _orderByLab.請使用Price昇冪排序後再使用Id昇冪排序();
